$(function () {
  ...
  $(".q10:not(li)").css("color", "red");

  // 問題11:疑似クラス empty
  // 疑似クラスemptyを使い、li要素が空の時、リストの中点の色を赤色に変えてください。
  $(".q11" > "li").empty("color", "red");
  ...
  $(".q33 >li:lt(1), .q33 >li:lt(2)").css("color", "red");
  ...
  $(".q35>h1:header, .q35>h5:header").css("color", "red");
  ...
  $(".q38 >li >span").parent("").css("color", "red");
  ...
  $(".q44 .secound").siblings().css("color", "red");
